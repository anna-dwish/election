...
grouped_voter_data %>% write_csv("grouped_voter_only_data_2016.csv")
...
fold_df <- groupdata2::fold(grouped_voter_data, k = 2, cat_col = c("age_bin", "race_ethnicity", "gender","county_desc")) 
```
