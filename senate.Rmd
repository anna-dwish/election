...
```{r}
##  ETHAN 
senate_gamma_5_2.5_mu_7.5.prior <- "
  nu_y ~ dunif(0,100)
  tau_y ~ dunif(0,100)
  ...
  sigma2_0_inv ~ dgamma(5,2.5) # CHANGE THIS
  "
model_file_senate_gamma_5_2.5_mu_7.5.prior <- generate_senate_model_text(senate_gamma_5_2.5_mu_7.5.prior) # CHANGE THIS
if (file.exists("senate_gamma_5_2.5_mu_7.5.prior.Rds")) { # CHANGE THIS
  # CHANGE THIS
  senate_gamma_5_2.5_mu_7.5.prior_model <- readRDS("senate_gamma_5_2.5_mu_7.5.prior.Rds") # CHANGE THIS
} else {
  # CHANGE THIS
  senate_gamma_5_2.5_mu_7.5.prior_model <- jags(data = jags_data_senate,  
                                 parameters.to.save = c("theta", "Sigma", 
                                                        "p","sigma2_y", "sigma2_0"),
                                 n.iter = 75000, n.burnin = 25000, n.thin = 50, n.chains = 2,
                                                # CHANGE THIS
                                 model.file = model_file_senate_gamma_5_2.5_mu_7.5.prior)
              # CHANGE THIS                                   # CHANGE THIS
  saveRDS(senate_gamma_5_2.5_mu_7.5.prior_model, file = "senate_gamma_5_2.5_mu_7.5.prior.Rds")
}
                    # CHANGE THIS
