...
```{r}
##  ETHAN 
senate_gamma_5_5_mu_10_neg.1.prior <- "
  nu_y ~ dunif(0,100)
  tau_y ~ dunif(0,100)
  
  mu0 ~ dnorm(50, pow(10,-1)) # CHANGE THIS
  
  sigma2_0 = 1/sigma2_0_inv
  sigma2_0_inv ~ dgamma(5,5) # CHANGE THIS
  "

model_file_senate_gamma_5_5_mu_10_neg.1.prior <- generate_senate_model_text(senate_gamma_5_5_mu_10_neg.1.prior) # CHANGE THIS
if (file.exists("senate_gamma_5_5_mu_10_neg.1.prior.Rds")) { # CHANGE THIS
  # CHANGE THIS
  senate_gamma_5_5_mu_10_neg.1.prior_model <- readRDS("senate_gamma_5_5_mu_10_neg.1.prior.Rds") # CHANGE THIS
} else {
  # CHANGE THIS
  senate_gamma_5_5_mu_10_neg.1.prior_model <- jags(data = jags_data_senate,  
                                 parameters.to.save = c("theta", "Sigma","p","sigma2_y", "sigma2_0"),
                                 n.iter = 75000, n.burnin = 25000, n.thin = 50, n.chains = 2,
                                 model.file = model_file_senate_gamma_5_5_mu_10_neg.1.prior)
              # CHANGE THIS                                   # CHANGE THIS
  saveRDS(senate_gamma_5_5_mu_10_neg.1.prior_model, file = "senate_gamma_5_5_mu_10_neg.1.prior.Rds")
}
                    # CHANGE THIS
n_iter <- dim(senate_gamma_5_5_mu_10_neg.1.prior_model$BUGSoutput$sims.list$theta[,,1])[1]
...
for (i in 1:n_iter){
                                                                      # CHANGE THIS
  final_results_senate[i] = prediction_per_simulation_senate(senate_gamma_5_5_mu_10_neg.1.prior_model, i)
}
...
model_file_senate_gamma_4_2_mu_10.prior <- generate_senate_model_text(senate_gamma_4_2_mu_10.prior)
if (file.exists("senate_gamma_4_2_mu_10.prior.Rds")) {
  senate_gamma_4_2_mu_10.prior_model <- readRDS("senate_gamma_4_2_mu_10.prior.Rds")
} else {
  senate_gamma_4_2_mu_10.prior_model <- jags(data = jags_data_senate,  
                                 parameters.to.save = c("theta", "Sigma", 
                                                        "p","sigma2_y", "sigma2_0"),
                                 n.iter = 75000, n.burnin = 25000, n.thin = 50, n.chains = 2,
                                 model.file = model_file_senate_gamma_4_2_mu_10.prior)
  
  saveRDS(senate_gamma_4_2_mu_10.prior_model, file = "senate_gamma_4_2_mu_10.prior.Rds")
}

n_iter <- dim(senate_gamma_4_2_mu_10.prior_model$BUGSoutput$sims.list$theta[,,1])[1]
...
for (i in 1:n_iter){
  final_results_senate[i] = prediction_per_simulation_senate(senate_gamma_4_2_mu_10.prior_model, i)
}
