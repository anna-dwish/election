...
senate_gamma_4_2_prior <- "
  ...
  sigma2_0 = 1/sigma2_0_inv
  sigma2_0_inv ~ dgamma(4, 2)
  "

model_file <- generate_senate_model_text(senate_gamma_4_2_prior)
if (file.exists("senate_gamma_4_2_prior.Rds")) {
  senate_gamma_4_2_prior <- readRDS("senate_gamma_4_2_prior.Rds")
} else {
  senate_gamma_4_2_prior <- jags(data = jags_data_senate,  
                                     parameters.to.save = c("theta", "Sigma", 
                                                            "p","sigma2_y", "sigma2_0"),
                                     n.iter = 125000, n.burnin = 50000, n.thin = 75, n.chains = 2,
                                     model.file = model_file)
  
  saveRDS(senate_gamma_4_2_prior, file = "senate_gamma_4_2_prior.Rds")
}
```
