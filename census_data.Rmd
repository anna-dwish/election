...
for (row in 1:nrow(data)){
  if (data[row,"AGEGRP"] == 4){
    for (column in colnames(data_numeric)){
      data[row,column] <- 0.5*data[row, column]
  }
...
#codes in dataset
race_eth_genders <- c("H_MALE", "H_FEMALE", "NHIA_MALE", "NHIA_FEMALE","NHAA_MALE", "NHAA_FEMALE", "NHBA_MALE", "NHBA_FEMALE", "NHTOM_MALE", "NHTOM_FEMALE", "NHWA_MALE", "NHWA_FEMALE", "NHNA_MALE", "NHNA_FEMALE")

#map to these racial and ethnic identities
ethnicities <- c("Hispanic Any Race", "Hispanic Any Race", "Non-Hispanic American Indian", "Non-Hispanic American Indian", "Non-Hispanic Asian", "Non-Hispanic Asian", "Non-Hispanic Black", "Non-Hispanic Black", "Non-Hispanic Mixed", "Non-Hispanic Mixed", "Non-Hispanic White", "Non-Hispanic White", "Non-Hispanic Hawaiian/Pacific Islander", "Non-Hispanic Hawaiian/Pacific Islander")

genders <- c("male", "female","male", "female","male", "female","male", "female","male", "female","male", "female","male", "female")
...
final_df_merge <- final_df %>%
  mutate(county_desc = toupper(strsplit(county_desc, " ")[[1]][1]))
final_df_merge
