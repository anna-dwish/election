...
In Figure 4 in Appendix C, we explore the posterior predictive distributions of Biden’s electoral votes across different priors on $\frac{1}{\sigma^2_{0}}$. The solid purple lines indicate the posterior mean of `r mean_electoral` electoral votes from (1.1). The distribution of Biden's predicted electoral votes appears to be roughly consistent across different priors. Thus, our results are relatively insensitive to prior choice [[7]][Bibliography].
...
Figure ASLKDJFHALSF in Appendix C shows the proportion of Democratic voters in North Carolina across age groups, race/ethnicity, and sex. We see that as age increases, the proportion Non-Hispanic, American Indian, and Non-Hispanic Multi-Racial voters who vote democratically tends to increase. Conversely, for Hispanic Any Race individuals, Non-Hispanic Asians, and Non-Hispanic Whites, the proportion of democratic voters among total voters does not have any obvious increase with age.
...
Although we extracted meaningful outcomes from our analysis, there were several limitations to our methodology and available data. Firstly, although there is no strict definition of a swing state, our Linzer models for the Presidential and Senate elections assume these. Further, it is difficult to understand how our unique socio-political environment, exacerbated by the Coronavirus pandemic, will interfere with the various 2020 elections. It would be noteworthy to examine, for example, how voting methods, such as mail-in ballots, relate to the likelihood of voting Democratic or Republican- especially given the rising popularity of such options due to Covid-19. Unfortunately, sufficient data does not currently exist in order to perform such an analysis. 
...
```{r, fig.width=8, fig.align="center",warning=F, message=F, cache=TRUE, fig.show="hide"}
